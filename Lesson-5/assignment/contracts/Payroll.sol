...
contract Payroll is Ownable {
    ...
    function _getEmployeeIndex(address employeeId) private returns (uint index) {
    ...
    function removeEmployee(address employeeId) onlyOwner employeeExit(employeeId) {
        ...
        uint index = _getEmployeeIndex(employeeId);
    ...
    function checkInfo() returns (uint balance, uint runway, uint employeeCount) {
        balance = this.balance; // the balance of current contract
