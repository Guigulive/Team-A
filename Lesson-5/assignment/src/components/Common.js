...
class Common extends Component {
  constructor(props) {
    ...
    // init state and assign it into a dictionary
    // react.js can re-render the component every time when the state is changed
    this.state = {};
  }

  // callback will be invoked once this component added into DOM tree
  componentDidMount() {
    // props is passed via:
